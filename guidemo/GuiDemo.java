...
public class GuiDemo extends JFrame {
	...
	public GuiDemo() {
		...
		drawPanel.getTextItem().setText("Big bugs have little bugs\n" + "      Upon their backs to bite 'em,\n"
		...
		JToolBar tbar = new JToolBar(true ? JToolBar.HORIZONTAL : JToolBar.VERTICAL);
		...
		menuBar.add(iconSupport.createStamperMenu());
		setJMenuBar(menuBar);
	...
	private class ChooseBackgroundAction extends AbstractAction {
		...
		ChooseBackgroundAction(String text) {
			...
			if (text.equals("Color...")) {
				BufferedImage img = new BufferedImage(70, 32, BufferedImage.TYPE_INT_RGB);
				Graphics g = img.createGraphics();
				g.setColor(Color.WHITE);
				g.fillRect(0, 0, 32, 32);
				g.setColor(Color.RED);
				g.drawString("COLOR", 5, 20);
				g.dispose();
